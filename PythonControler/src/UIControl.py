...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.CtrlMode_Dig.setStyleSheet("")
        ...
        self.FlowSetUnit = QtWidgets.QLabel(self.horizontalLayoutWidget_2)
        self.FlowSetUnit.setObjectName("FlowSetUnit")
        self.horizontalLayout_2.addWidget(self.FlowSetUnit)
        ...
        self.GetPoint.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.GetPoint.setSmallDecimalPoint(True)
        self.GetPoint.setDigitCount(5)
        self.GetPoint.setSegmentStyle(QtWidgets.QLCDNumber.Filled)
        self.GetPoint.setProperty("value", 888888.0)
        self.GetPoint.setProperty("intValue", 888888)
        self.GetPoint.setObjectName("GetPoint")
        self.horizontalLayout_3.addWidget(self.GetPoint)
        self.FlowShowUnit = QtWidgets.QLabel(self.horizontalLayoutWidget_3)
        self.FlowShowUnit.setObjectName("FlowShowUnit")
        self.horizontalLayout_3.addWidget(self.FlowShowUnit)
...
"}")
    ...
    def retranslateUi(self, Dialog):
        ...
        self.FlowSetUnit.setText(_translate("Dialog", "% of F.S."))
        self.groupBox_5.setTitle(_translate("Dialog", "瞬时流量"))
        self.FlowShowUnit.setText(_translate("Dialog", "% of F.S."))
